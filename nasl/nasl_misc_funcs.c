...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_rand (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_usleep (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_sleep (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int slp = get_int_var_by_num (lexic, 0, 0);
  sleep (slp);
  return FAKE_CELL;
...
tree_cell *
nasl_ftp_log_in (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *u, *p;
  int soc;
  tree_cell *retc;
...
tree_cell *
nasl_ftp_get_pasv_address (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
...
tree_cell *
nasl_telnet_init (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_start_denial (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_end_denial (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  ...
  if (!port)
    {
      ...
      if (ping)
        return nasl_tcp_ping (lexic,info);
      else
        {
          retc = alloc_tree_cell (0, NULL);
          retc->type = CONST_INT;
...
tree_cell *
nasl_dump_ctxt (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_do_exit (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_isnull (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int t;
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_make_list (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  int i, j, vi;
  anon_nasl_var *v;
...
tree_cell *
nasl_make_array (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  int vi;
  anon_nasl_var *v, *v2;
...
tree_cell *
nasl_keys (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
...
tree_cell *
nasl_max_index (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  anon_nasl_var *v;
  nasl_array *a;
...
tree_cell *
nasl_typeof (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  anon_nasl_var *u;
  const char *s;
...
tree_cell *
nasl_defined_func (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  void *f;
  char *s;
  tree_cell *retc;
...
tree_cell *
nasl_func_named_args (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  nasl_func *f;
  char *s;
  int i;
...
tree_cell *
nasl_func_unnamed_args (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  nasl_func *f;
  char *s;
  tree_cell *retc;
...
tree_cell *
nasl_func_has_arg (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  nasl_func *f;
  char *s;
  int vt, i, flag = 0;
...
tree_cell *
nasl_sort_array (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  nasl_array *a;
  ...
  mylexic = lexic;
  retc = nasl_make_list (lexic,info);
  if (retc != NULL)
    {
      a = retc->x.ref_val;
...
tree_cell *
nasl_unixtime (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
nasl_gettimeofday (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct timeval t;
  char str[64];
...
tree_cell *
nasl_localtime (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct tm *ptm;
  time_t tictac;
...
tree_cell *
nasl_mktime (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct tm tm;
  tree_cell *retc;
  time_t tictac;
...
tree_cell *
nasl_open_sock_kdc (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  int ret, type;
...
tree_cell *
nasl_gunzip (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
nasl_gzip (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
nasl_dec2str (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_get_byte_order (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  short w = 0x0001;
  char *p = (char *) &w;
