 ...
 */
tree_cell *
nasl_ssh_connect (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  ssh_session session;
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_ssh_disconnect (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  int session_id;
 ...
 */
tree_cell *
nasl_ssh_session_id_from_sock (lex_ctxt *lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_ssh_get_sock (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot, sock;
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_ssh_set_login (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
 ...
 */
tree_cell *
nasl_ssh_userauth (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  int session_id;
  ssh_session session;
  ...
  /* Check if we need to set the user.  This is done only once per
     session.  */
  if (!session_table[tbl_slot].user_set && !nasl_ssh_set_login (lexic,info))
    return NULL;
 ...
 */
tree_cell *
nasl_ssh_request_exec (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  int session_id;
  ssh_session session;
 ...
 */
tree_cell *
nasl_ssh_get_issue_banner (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  ssh_session session;
  char *banner;
 ...
 */
tree_cell *
nasl_ssh_get_server_banner (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  ssh_session session;
  const char *banner;
 ...
 */
tree_cell *
nasl_ssh_get_host_key (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  ssh_session session;
  ssh_string sstring;
 ...
 */
tree_cell *
nasl_ssh_get_auth_methods (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  int methods;
  GString *buffer;
 ...
 */
tree_cell *
nasl_ssh_shell_open (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  ssh_channel channel;
  ssh_session session;
 ...
 */
tree_cell *
nasl_ssh_shell_read (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int tbl_slot;
  ssh_channel channel;
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_ssh_shell_write (lex_ctxt *lexic,DaltonScriptInfo *info)
{
