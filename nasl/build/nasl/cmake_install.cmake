...
FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES
    "/media/snouto/rest/projects/dalton/libs/openvas-libraries-8.0.7/nasl/build/nasl/libopenvas_nasl.so.8.0.7"
    "/media/snouto/rest/projects/dalton/libs/openvas-libraries-8.0.7/nasl/build/nasl/libopenvas_nasl.so.8"
    "/media/snouto/rest/projects/dalton/libs/openvas-libraries-8.0.7/nasl/build/nasl/libopenvas_nasl.so"
    )
  FOREACH(file
      "$ENV{DESTDIR}/usr/local/lib/libopenvas_nasl.so.8.0.7"
      "$ENV{DESTDIR}/usr/local/lib/libopenvas_nasl.so.8"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/media/snouto/rest/projects/dalton/libs/openvas-libraries-8.0.7/nasl/build/nasl/openvas-nasl")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/openvas-nasl" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/openvas-nasl")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/openvas-nasl")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/media/snouto/rest/projects/dalton/libs/openvas-libraries-8.0.7/nasl/build/nasl/openvas-nasl-lint")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/openvas-nasl-lint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/openvas-nasl-lint")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/openvas-nasl-lint")
