 ...
 */
tree_cell *
nasl_cert_open (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  gpg_error_t err;
  tree_cell *retc;
  const char *data;
 ...
 */
tree_cell *
nasl_cert_close (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int object_id;
 ...
 */
tree_cell *
nasl_cert_query (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int object_id;
  object_desc_t obj;
  const char *command;
