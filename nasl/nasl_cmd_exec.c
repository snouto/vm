...
tree_cell *
nasl_pread (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_find_in_path (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *cmd;
 ...
 */
tree_cell *
nasl_fread (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *fname;
 ...
 */
tree_cell *
nasl_unlink (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *fname;
 ...
 */
tree_cell *
nasl_fwrite (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *content, *fname;
  struct stat lstat_info, fstat_info;
...
tree_cell *
nasl_get_tmp_dir (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_file_stat (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *fname;
  struct stat st;
 ...
 */
tree_cell *
nasl_file_open (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *fname, *mode;
  struct stat lstat_info, fstat_info;
 ...
 */
tree_cell *
nasl_file_close (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  int fd;
 ...
 */
tree_cell *
nasl_file_read (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *buf;
  int fd;
 ...
 */
tree_cell *
nasl_file_write (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *content;
  int len;
 ...
 */
tree_cell *
nasl_file_seek (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  int fd;
  int foffset;
