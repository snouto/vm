 ...
 */
tree_cell *
forge_ipv6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct ip6_hdr *pkt;
  char *s;
 ...
 */
tree_cell *
get_ipv6_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct ip6_hdr *ip6 =
 ...
 */
tree_cell *
set_ipv6_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
dump_ipv6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i;
...
tree_cell *
insert_ipv6_options (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct ip6_hdr *ip6 =
    (struct ip6_hdr *) get_str_local_var_by_name (lexic, "ip6");
 ...
 */
tree_cell *
forge_tcp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *data;
  int len;
 ...
 */
tree_cell *
get_tcp_v6_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
set_tcp_v6_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
dump_tcp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i = 0;
  u_char *pkt;
 ...
 */
tree_cell *
forge_udp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct ip6_hdr *ip6 =
    (struct ip6_hdr *) get_str_local_var_by_name (lexic, "ip6");
 ...
 */
tree_cell *
get_udp_v6_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *udp;
  char *element;
 ...
 */
tree_cell *
set_udp_v6_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct ip6_hdr *ip6 =
 ...
 */
tree_cell *
dump_udp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i = 0;
  u_char *pkt;
  while ((pkt = (u_char *) get_str_var_by_num (lexic, i++)) != NULL)
 ...
 */
tree_cell *
forge_icmp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  struct ip6_hdr *ip6;
 ...
 */
tree_cell *
get_icmp_v6_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct icmp6_hdr *icmp;
  char *p;
 ...
 */
tree_cell *
forge_igmp_v6_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct ip6_hdr *ip6 =
    (struct ip6_hdr *) get_str_local_var_by_name (lexic, "ip6");
...
/*---------------------------------------------------------------------------*/
tree_cell *
nasl_tcp_v6_ping (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int port;
 ...
 */
tree_cell *
nasl_send_v6packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
