...
tree_cell *
get_hostname (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
get_host_ip (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
...
tree_cell *
get_host_open_port (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
...
tree_cell *
get_port_state (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int open;
  struct arglist *script_infos = lexic->script_infos;
  tree_cell *retc;
...
tree_cell *
get_udp_port_state (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int open;
  struct arglist *script_infos = lexic->script_infos;
  tree_cell *retc;
...
tree_cell *
nasl_islocalhost (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
...
tree_cell *
nasl_islocalnet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
  struct in6_addr *ip = plug_get_host_ip (script_infos);
  tree_cell *retc;
...
tree_cell *
nasl_this_host (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
  tree_cell *retc;
  char hostname[255];
...
tree_cell *
nasl_this_host_name (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *hostname;
  tree_cell *retc;
 ...
 */
tree_cell *
get_port_transport (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
  tree_cell *retc;
...
tree_cell *
nasl_same_host (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct hostent *h;
  char *hn[2], **names[2];
...
tree_cell *
nasl_target_is_ipv6 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct arglist *script_infos = lexic->script_infos;
  struct in6_addr *addr;
