...
tree_cell *
nasl_open_priv_sock_tcp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_open_privileged_socket (lexic, IPPROTO_TCP);
}

tree_cell *
nasl_open_priv_sock_udp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_open_sock_tcp_bufsz (lex_ctxt * lexic, int bufsz,DaltonScriptInfo *info)
{
  int soc = -1;
  struct arglist *script_infos = lexic->script_infos;
  int to, port;
 ...
 */
tree_cell *
nasl_open_sock_tcp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_open_sock_tcp_bufsz (lexic, -1,info);
}
 ...
 */
tree_cell *
nasl_open_sock_udp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
  tree_cell *retc;
  int port;
...
tree_cell *
nasl_socket_negotiate_ssl (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_socket_get_cert (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc, cert_len = 0;
  tree_cell *retc;
  void *cert;
...
tree_cell *
nasl_socket_get_ssl_session_id (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
  size_t sid_len = 0;
  tree_cell *retc;
...
tree_cell *
nasl_socket_get_ssl_compression (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
  tree_cell *retc;
...
tree_cell *
nasl_socket_get_ssl_version (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
  int version;
  tree_cell *retc;
...
tree_cell *
nasl_socket_get_ssl_ciphersuite (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc, result;
  tree_cell *retc;
...
tree_cell *
nasl_recv (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *data;
...
tree_cell *
nasl_recv_line (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int len = get_int_local_var_by_name (lexic, "length", -1);
  int soc = get_int_local_var_by_name (lexic, "socket", 0);
...
tree_cell *
nasl_send (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc = get_int_local_var_by_name (lexic, "socket", 0);
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_close_socket (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int soc;
  int type;
  unsigned int opt_len = sizeof (type);
...
tree_cell *
nasl_join_multicast_group (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *a;
  int i, j;
  struct ip_mreq m;
...
tree_cell *
nasl_leave_multicast_group (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *a;
  struct in_addr ia;
  int i;
...
tree_cell *
nasl_get_source_port (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_socket_get_error (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_get_sock_info (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int sock;
  int type;
  int err;
