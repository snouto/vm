...
tree_cell *
nasl_string (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  int vi, vn, newlen;
  int sz, typ;
...
tree_cell *
nasl_rawstring (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  int vi, vn, i, j, x;
  int sz, typ;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_strlen (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_strcat (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *s;
  int vi, vn, newlen;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_display (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *r, *retc;
  int j;

  r = nasl_string (lexic,info);
...
tree_cell *
nasl_hex (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
nasl_hexstr (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_ord (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_tolower (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_toupper (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *str = get_str_var_by_num (lexic, 0);
  int str_len = get_var_size_by_num (lexic, 0);
...
tree_cell *
nasl_ereg (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_ereg_replace (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *pattern = get_str_local_var_by_name (lexic, "pattern");
 ...
 */
tree_cell *
nasl_egrep (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *pattern = get_str_local_var_by_name (lexic, "pattern");
  char *string = get_str_local_var_by_name (lexic, "string");
  int icase = get_int_local_var_by_name (lexic, "icase", 0);
 ...
 */
tree_cell *
nasl_eregmatch (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *pattern = get_str_local_var_by_name (lexic, "pattern");
  char *string = get_str_local_var_by_name (lexic, "string");
  int icase = get_int_local_var_by_name (lexic, "icase", 0);
 ...
 */
tree_cell *
nasl_substr (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *s1;
 ...
 */
tree_cell *
nasl_insstr (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *s1, *s2, *s3;
...
tree_cell *
nasl_match (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *pattern = get_str_local_var_by_name (lexic, "pattern");
  char *string = get_str_local_var_by_name (lexic, "string");
  int icase = get_int_local_var_by_name (lexic, "icase", 0);
...
tree_cell *
nasl_split (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  nasl_array *a;
  char *p, *str, *sep;
...
tree_cell *
nasl_chomp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *p = NULL, *str;
  int i, len;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_crap (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
nasl_strstr (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_stridx (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *a = get_str_var_by_num (lexic, 0);
  int sz_a = get_var_size_by_num (lexic, 0);
  char *b = get_str_var_by_num (lexic, 1);
 ...
 */
tree_cell *
nasl_str_replace (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *a, *b, *r, *s, *c;
...
/*---------------------------------------------------------------------*/
tree_cell *
nasl_int (lex_ctxt * lexic,DaltonScriptInfo *info)
{
