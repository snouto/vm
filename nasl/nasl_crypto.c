...
tree_cell *
nasl_md2 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hash (lexic, GCRY_MD_MD2);
}

tree_cell *
nasl_md4 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hash (lexic, GCRY_MD_MD4);
}

tree_cell *
nasl_md5 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hash (lexic, GCRY_MD_MD5);
}

tree_cell *
nasl_sha1 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hash (lexic, GCRY_MD_SHA1);
}

tree_cell *
nasl_sha256 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hash (lexic, GCRY_MD_SHA256);
}

tree_cell *
nasl_ripemd160 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_hmac_md2 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hmac (lexic, GCRY_MD_MD2);
}

tree_cell *
nasl_hmac_md5 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hmac (lexic, GCRY_MD_MD5);
}

tree_cell *
nasl_hmac_sha1 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_hmac (lexic, GCRY_MD_SHA1);
}

tree_cell *
nasl_hmac_ripemd160 (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
/*-------------------[ Windows ]-------------------------------------*/
tree_cell *
nasl_get_sign (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_ntlmv2_response (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_ntlm2_response (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *cryptkey = (char *) get_str_var_by_name (lexic, "cryptkey");
...
tree_cell *
nasl_ntlm_response (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *cryptkey = (char *) get_str_var_by_name (lexic, "cryptkey");
  char *password = get_str_var_by_name (lexic, "password");
  unsigned char *nt_hash =
...
tree_cell *
nasl_keyexchg (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *cryptkey = (char *) get_str_var_by_name (lexic, "cryptkey");
...
tree_cell *
nasl_ntlmv1_hash (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_nt_owf_gen (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_lm_owf_gen (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *pass = get_str_var_by_num (lexic, 0);
  int pass_len = get_var_size_by_num (lexic, 0);
  tree_cell *retc;
...
tree_cell *
nasl_insert_hexzeros (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_ntv2_owf_gen (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_ntlmv2_hash (lex_ctxt * lexic,DaltonScriptInfo *info)
{
