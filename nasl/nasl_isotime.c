 ...
 */
tree_cell *
nasl_isotime_now (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
 ...
 */
tree_cell *
nasl_isotime_is_valid (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  int result = 0;
  tree_cell *retc;
  my_isotime_t timebuf;
 ...
 */
tree_cell *
nasl_isotime_scan (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  my_isotime_t timebuf;
  int datalen;
 ...
 */
tree_cell *
nasl_isotime_print (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  const char *string;
  char helpbuf[20];
 ...
 */
tree_cell *
nasl_isotime_add (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  my_isotime_t timebuf;
  const char *string;
