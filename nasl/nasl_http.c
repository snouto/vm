...
tree_cell *
http_open_socket (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_open_sock_tcp_bufsz (lexic, 65536);
}

tree_cell *
http_close_socket (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  return nasl_close_socket (lexic,info);
}
 ...
 */
tree_cell *
http_get (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
http_head (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
http_post (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
http_delete (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
http_put (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
cgibin (lex_ctxt * lexic,DaltonScriptInfo *info)
{
