 ...
 */
tree_cell *
nasl_bn_cmp (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_bn_random (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  gcry_mpi_t key = NULL;
  long need;
 ...
 */
tree_cell *
nasl_pem_to_rsa (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_pem_to_dsa (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_dh_generate_key (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_dh_compute_key (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_rsa_public_decrypt (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_rsa_sign (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  char *data;
  int data_size;
 ...
 */
tree_cell *
nasl_dsa_do_verify (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_dsa_do_sign (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
 ...
 */
tree_cell *
nasl_bf_cbc_encrypt (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_bf_cbc_decrypt (lex_ctxt * lexic,DaltonScriptInfo *info)
{
