 ...
 */
tree_cell *
nasl_smb_versioninfo (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_smb_connect (lex_ctxt * lexic,DaltonScriptInfo *info)
{
 ...
 */
tree_cell *
nasl_smb_close (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  SMB_HANDLE handle =
 ...
 */
tree_cell *
nasl_smb_file_SDDL (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  SMB_HANDLE handle =
    (SMB_HANDLE) get_int_local_var_by_name (lexic, "smb_handle", 0);
 ...
 */
tree_cell *
nasl_smb_file_owner_sid (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  SMB_HANDLE handle =
    (SMB_HANDLE) get_int_local_var_by_name (lexic, "smb_handle", 0);
  char *filename = get_str_local_var_by_name (lexic, "filename");
 ...
 */
tree_cell *
nasl_smb_file_group_sid (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  SMB_HANDLE handle =
    (SMB_HANDLE) get_int_local_var_by_name (lexic, "smb_handle", 0);
  char *filename = get_str_local_var_by_name (lexic, "filename");
 ...
 */
tree_cell *
nasl_smb_file_trustee_rights (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  SMB_HANDLE handle =
    (SMB_HANDLE) get_int_local_var_by_name (lexic, "smb_handle", 0);
  char *filename = get_str_local_var_by_name (lexic, "filename");
...
tree_cell *
nasl_win_cmd_exec (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
  struct in6_addr *host = plug_get_host_ip (script_infos);
  char *ip;
