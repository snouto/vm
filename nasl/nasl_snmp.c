...
tree_cell *
nasl_snmpv1_get (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  return nasl_snmpv1v2c_get (lexic, SNMP_VERSION_1);
}

tree_cell *
nasl_snmpv2c_get (lex_ctxt *lexic,DaltonScriptInfo *info)
{
  return nasl_snmpv1v2c_get (lexic, SNMP_VERSION_2c);
}

tree_cell *
nasl_snmpv3_get (lex_ctxt *lexic,DaltonScriptInfo *info)
{
