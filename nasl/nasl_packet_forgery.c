...
tree_cell *
forge_ip_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct ip *pkt;
  char *s;
...
tree_cell *
get_ip_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
...
tree_cell *
set_ip_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
insert_ip_options (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct ip *ip = (struct ip *) get_str_local_var_by_name (lexic, "ip");
...
tree_cell *
dump_ip_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i;
...
tree_cell *
forge_tcp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *data;
  int len;
...
tree_cell *
get_tcp_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
set_tcp_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
dump_tcp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i = 0;
  u_char *pkt;
...
tree_cell *
forge_udp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  struct ip *ip = (struct ip *) get_str_local_var_by_name (lexic, "ip");
...
tree_cell *
get_udp_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc;
  char *udp;
  char *element;
...
tree_cell *
set_udp_elements (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
dump_udp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  int i = 0;
  u_char *pkt;
  while ((pkt = (u_char *) get_str_var_by_num (lexic, i++)) != NULL)
...
tree_cell *
forge_icmp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  tree_cell *retc = NULL;
  struct ip *ip;
  struct ip *ip_icmp;
...
tree_cell *
get_icmp_element (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct icmp *icmp;
  char *p;
...
tree_cell *
forge_igmp_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct ip *ip = (struct ip *) get_str_local_var_by_name (lexic, "ip");
...
tree_cell *
nasl_tcp_ping (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  struct arglist *script_infos = lexic->script_infos;
  struct in6_addr *dst = plug_get_host_ip (script_infos);
  if (IN6_IS_ADDR_V4MAPPED (dst) != 1)
    {
      tree_cell *retc = nasl_tcp_v6_ping (lexic,info);
      return retc;
    }
  int port;
...
tree_cell *
nasl_send_packet (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_pcap_next (lex_ctxt * lexic,DaltonScriptInfo *info)
{
...
tree_cell *
nasl_send_capture (lex_ctxt * lexic,DaltonScriptInfo *info)
{
  char *interface = get_str_local_var_by_name (lexic, "interface");
  int bpf = -1;
  static char errbuf[PCAP_ERRBUF_SIZE];
